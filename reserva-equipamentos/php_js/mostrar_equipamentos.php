...
if ($_GET['filtro'] == 'reservar') {
    // $extraWhere = 'emprestado=0 AND ativo=1';
    $extraWhere = 'emprestado=0 AND ativo=1 AND existe=1';
}

if ($_GET['filtro'] == 'gerenciar'){
    $extraWhere = 'existe=1';
}
$joinQuery="";
$groupBy="";

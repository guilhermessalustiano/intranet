...
<nav class='navbar bg-iel-vermelho navbar-expand-lg'>
        ...
        <nav class='navbar bg-iel-vermelho navbar-expand-lg'>
            <div style='width: 100%'>
                <div class='container'>
                    <center>
                        <h4 class='bg-iel-vermelho'>Agendamento de Salas</h4>
...
echo("      <nav class='navbar sticky-top navbar-expand-lg navbar-iel-azul bg-iel-vermelho'>
    ...
    if (checkIsAdmin($_SESSION['username'])) {
        echo("
        <li class='nav-item'>
            <a class='nav-link' href='gerenciar_salas.php'>Gerenciar Salas </a>
        </li>
        <li class='nav-item'>
            <a class='nav-link' href='gerenciar_recursos.php'>Gerenciar Recursos</a>
        </li></ul>");
        }
